...
<!-- 引入主题响应式样式表-->
<link rel="stylesheet" type="text/css" href="<?php echo THEME_URI.'/css/responsive.css'; ?>"  />
<!-- 引入自定义样式表 -->
<link rel="stylesheet" type="text/css" href="<?php echo THEME_URI.'/framework/functions/css-customize.php'; ?>"  />
<!-- 引入字体样式表-->
...
<script src="<?php echo THEME_URI.'/js/css3-mediaqueries.js'; ?>"></script>
<script src="<?php echo THEME_URI.'/js/PIE_IE678.js'; ?>"></script>
<link rel="stylesheet" type="text/css" href="<?php echo THEME_URI.'/css/iefix.css'; ?>"  media="all" />
<![endif]-->
<!--[if IE 7]>
<link rel="stylesheet" type="text/css" href="<?php echo THEME_URI.'/fonts/font-awesome/font-awesome-ie7.min.css'; ?>"  media="all" />
<![endif]-->
<!--[if IE 6]>
<script src="<?php echo THEME_URI.'/js/kill-IE6.js'; ?>"></script>
<![endif]-->
</head>
...
<div id="navmenu-mobile-wraper">
	...
	<?php get_template_part('framework/modules/head-login-mobile'); ?>
	</div>
...
<header class="header-wrap" id="nav-scroll">
	<div class="nav-wrap">
			...
			<!-- /.Search button -->
			<!-- Login status -->
			<?php get_template_part('framework/modules/head-login'); ?>
			<!-- /.Login status -->
			<!-- Focus us -->
			<?php get_template_part('framework/modules/focus'); ?>
			<!-- /.Focus us -->			
			<!-- Menu Items Begin -->
