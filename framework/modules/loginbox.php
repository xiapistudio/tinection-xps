...
<div id="sign" class="sign">
    ...
    <form id="login" action="<?php echo get_option('home'); ?>/wp-login.php" method="post" novalidate="novalidate">
        ...
        <p class="safe">
            ...
            <a class="lost" href="<?php echo get_option('home'); ?>/wp-login.php?action=lostpassword"><?php _e('忘记密码 ?','xiapistudio'); ?></a>
        </p>
        <p>
    ...
    <div class="other-sign">
      ...
      <div class="<?php echo $cls; ?>"><a class="qqlogin" href="<?php echo home_url('/?connect=qq&action=login&redirect='.urlencode(tin_get_redirect_uri())) ?>"><i class="fa fa-qq"></i><span><?php _e('Q Q 登 录','xiapistudio'); ?></span></a></div>
	  <?php } ?>
	  <?php if(ot_get_option('tin_open_weibo')=='on') { ?>
	  <div class="<?php echo $cls; ?>"><a class="weibologin" href="<?php echo home_url('/?connect=weibo&action=login&redirect='.urlencode(tin_get_redirect_uri())) ?>"><i class="fa fa-weibo"></i><span><?php _e('微 博 登 录','xiapistudio'); ?></span></a></div>
	  <?php } ?>
      <?php if(ot_get_option('tin_open_weixin')=='on') { ?>
      <div class="<?php echo $cls; ?>"><a class="weixinlogin" href="<?php echo home_url('/?connect=weixin&action=login&redirect='.urlencode(tin_get_redirect_uri())) ?>"><i class="fa fa-weixin"></i><span><?php _e('微 信 登 录','xiapistudio'); ?></span></a></div>
      <?php } ?>
    </div>
	<?php } ?>
    </div>
