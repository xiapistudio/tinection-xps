...
<div class="bloglist-container clr" id="fluid_blocks">
<?php while (have_posts()) : the_post();?>
<span class="col span_1_of_3 masonry-box">
<article class="home-blog-entry clr">
	<?php  if(!get_post_format()) { $format = 'standard'; } else { $format = get_post_format(); }?>
	<?php get_template_part('framework/modules/thumbnail_ut',esc_attr( $format )); ?>
