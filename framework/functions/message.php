...
/* 添加消息
/* --------- */
function fun_add_message( $uid=0, $type='', $date='', $title='', $content='' ){
...
// 添加消息的定时器
add_action( 'fun_add_message_event', 'fun_add_message', 10, 5 );

/* 更新状态
/* --------- */
function fun_update_message_type( $id=0, $uid=0, $type='' ){
...
// 更新状态的定时器
add_action( 'fun_update_message_type_event', 'fun_update_message_type', 10, 3 );
 ...
 * @param int $offset
 */
function fun_get_message( $uid=0 , $count=0, $where='', $limit=0, $offset=0 ){
 ...
 * @param int $offset
 */
function fun_get_credit_message( $uid=0 , $limit=0, $offset=0 ){
...
/* 获取私信
/* ---------- */
function fun_get_pm( $pm=0, $from=0, $count=false, $single=false, $limit=0, $offset=0 ){
